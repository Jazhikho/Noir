...
public class GameController : MonoBehaviour
{
    ...
    void Awake()
    {
        GameController[] controllers = FindObjectsByType<GameController>(FindObjectsSortMode.None);
    ...
    private void Start()
    {
        ...
        if ((mainMenu = FindFirstObjectByType<MainMenu>()) == null)
        {
            loadingCoroutine = LoadMenu();
            StartCoroutine(loadingCoroutine);
        }
        else if (FindFirstObjectByType<Chapter>() != null)
        {
    ...
    IEnumerator LoadMenu()
    {
        ...
        if (FindFirstObjectByType<Chapter>() != null)
        {
    ...
    {
        currentChapter = FindFirstObjectByType<Chapter>();
